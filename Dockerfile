...
RUN pip install --no-cache-dir fastapi uvicorn[standard] sqlalchemy psycopg2-binary python-multipart cloudinary python-jose[cryptography] bcrypt pydantic[email]
